...
(function(expose) {
  ...
  function render_tree( jsonml ) {
    ...
    if ( tag == "img" || tag == "br" || tag == "hr" ) {
      ...
      var isBlockTag = tag == 'ul' || tag == 'ol' || tag == 'pre';
      var trailingNewlines = isBlockTag ? "\n\n" : "";

    	// Remove any trailing double linebreaks that arose from block tags.
    	content = content.join("")
    		.replace(/\n\n$/, "");


    	return "<"+ tag + tag_attrs + ">" + content + "</" + tag + ">" + trailingNewlines;
    }
  }
} ) ( (function() {
