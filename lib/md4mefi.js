(function(args) {
	...
	expose.dumpTokens = function(markdownText) {
	...
	expose.mangleAndParse = function(markdownText) {
		var tokens = marked.lexer(markdownText);
		console.log(tokens);
		tokens = expose.mangleTokenNewlines(tokens);
		expose.parseTokens(tokens);
	}
	...
	// expose.parseTokens = function(tokens) {
	...
	// 	var parserOptions = {
	// 		renderer: renderer,
	// 		// marked's implementation of smartypants doesn't do 
	// 		// everything we want. We'll go back later and smartypants 
	// 		// it up.
	// 		smartypants: false,
	// 	};
