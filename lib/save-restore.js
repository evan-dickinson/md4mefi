(function(args) {
  ...
  // in the future.
  expose.isRestoredMarkdownStale = function(htmlCommentText,
                                    htmlExtendedText,
                                    storedJson) {
    ...
    // We didn't unearth any old JSON, but we
    // did get passed in some HTML. Abort!
    if (storedJson === null && 
      (hasHtmlComment || hasHtmlExtended)) {
    ...
    // the empty string.
    return hasHtmlComment  && !hasMdComment ||
