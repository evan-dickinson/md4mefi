(function(jQuery) {
  ...
  $(document).ready(function() {
    ...
    var storedJson = restoreMarkdown({
    ...
    // HTML mode.
    if (isRestoredMarkdownStale(htmlComment.val(), 
                                htmlExtended.val(), 
                                storedJson)) {

      // TODO: Abort with a message
    ...
    previewButton.click(eventData, function(event) {
      saveMarkdownForPreview({
