(function(jQuery) {
  ...
  var getSessionStorageKey = function(form) {
    ...
    if (linkIdInput.length === 0) {
      // TODO: Don't return here! This page is probably
      // a submission page for a new post. Look it up
      // by some other key: URL maybe?
      return null;
    }
    else {
  ...
  $(document).ready(function() {
    ...
    // Handlers for saving markdown on server-side preview
