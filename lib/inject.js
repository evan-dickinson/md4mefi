(function(jQuery) {
  ...
  var doItalics = function(event) {
    var mdComment = event.data.mdComment;    
    var selection = mdComment.selection();

    if (selection === "") {
      mdComment.selection('insert', {text: '_italic text_', mode: 'before'});
    }
    else {
      mdComment.selection('insert', {text: '_', mode: 'before' });
      mdComment.selection('insert', {text: '_', mode: 'after' });      
    }
  ...
  $(document).ready(function() {
    ...
    italicButton.click(eventData, doItalics);
  });
